# Markdown guide to setup a Linux machine in CloudVeneto for C Code Compilation and Execution
...
- If you are outside the university network, copy the file `my_key.pem` in the gate machine (credentials for accessing were sent to you when your account on the cloud was created):
  ```bash
